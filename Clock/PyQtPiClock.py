...
class Radar(QtGui.QLabel):
    ...
    def mapboxbaseurl(self, radar, rect):
        ...
        basemap = 'mapbox/satellite-streets-v10'
        if 'basemap' in radar:
    ...
    def mapboxoverlayurl(self, radar, rect):
        #  note we're using google maps zoom factor.
        #  Mapbox equivilant zoom is one less
        #  They seem to be using 512x512 tiles instead of 256x256
        overlay = ''
    ...
    def getoverlay(self):
        ...
        QtCore.QObject.connect(self.overlayreply, QtCore.SIGNAL(
            "finished()"), self.overlayfinished)
